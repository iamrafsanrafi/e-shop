...
const ProductAdditionalInformations = ({ product, specifications }) => {
    ...
    return (
        <div className="mt-8 lg:mt-[100px] mb-16 border-b border-[#CBCBCB] pb-6 sm:pb-20">
                        ...
                        <tbody className="flex flex-col gap-y-6">
                            {specifications.map(spec => (
                                <tr className="flex" key={spec.key}>
                                    <td className="text-[#303030] font-['Poppins'] sm:text-xl font-semibold leading-[30px] w-[135px] sm:w-[210px]">{spec.key}</td>
