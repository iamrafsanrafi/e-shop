...
const Facilities = () => {
    return (
        <div className="sm:px-5 2xl:px-0">
            <Container>
                <div className="flex flex-col lg:flex-row relative pl-8 sm:pl-12 md:pl-14 lg:pl-0 lg:justify-between my-8 lg:my-20 gap-4 lg:gap-2">
                    ...
                    <div className="flex items-center gap-3 sm:gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-[#303030] text-sm xl:text-base font-['Montserrat'] leading-6 mt-[2px]">Fast, and reliable worldwide</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 sm:gap-6">
                        <div>
